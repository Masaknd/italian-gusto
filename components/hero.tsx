...
export function HomeHeroSection({ copy }: { copy: HomePageCopy }) {
  return (
    <section className='gusto-hero relative isolate h-screen overflow-hidden px-4 py-0 sm:px-[86px] xl:px-24 xl:py-[132px_64px] 3xl:px-[max(12vw,calc((100vw_-_1920px)/2))] 3xl:py-[132px_64px]'>
      <Marquee
        className='gusto-vertical hidden sm:top-[500px] sm:left-[-235px] sm:flex sm:h-[60px] sm:w-[527px] sm:origin-center sm:items-center sm:justify-start sm:text-[length:68px] sm:leading-[90px] sm:tracking-[-0.25em] sm:[text-shadow:var(--shadow-hero-title)] xl:top-[120px] xl:left-[90px] xl:block xl:h-auto xl:w-auto xl:origin-top-left xl:text-[86px] xl:leading-[90px] xl:tracking-[-0.25em] 2xl:top-[164px] 3xl:top-[270px]'
      ...
      <div className='relative w-full'>
        ...
        <div className='absolute z-10 flex w-max flex-col items-start gap-12 sm:top-0 sm:left-0 xl:top-20 xl:left-20 2xl:top-30 2xl:left-30 3xl:top-30 3xl:left-10'>
          ...
          <Image
            ...
            width={360}
            height={246}
            className='pointer-none: gusto-hero-veg absolute right-40 -bottom-125 z-2 h-auto w-[202px] sm:right-0 sm:-bottom-160 sm:w-[347px] xl:-right-30 xl:-bottom-20 2xl:-right-25 2xl:-bottom-20 2xl:w-[315px] 3xl:right-0 3xl:-bottom-30 3xl:w-[360px]'
          />
        </div>
        {/* right content */}
