...
export function HomeReservationSection({
  ...
  return (
    <section
      id='reservation'
      className="gusto-reservation relative isolate flex items-center justify-center overflow-hidden p-[100px_16px] text-content after:absolute after:inset-0 after:z-[-1] after:bg-black/70 after:mix-blend-multiply after:content-[''] sm:h-208 sm:p-0 lg:h-180 lg:min-h-0 lg:p-[56px_24px] xl:h-228.5 xl:p-0"
    >
      <Image
      ...
      />
      <div className='gusto-booking z-1 flex flex-col items-center justify-start gap-6 p-4 text-center [background:rgb(27_40_27/70%)] sm:p-8 lg:p-14'>
