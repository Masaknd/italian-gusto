  ...
  return (
    ...
    >
      ...
      <Image
        ...
        height={72}
        sizes='100vw'
        className='gusto-reservation-brush-top pointer-events-none absolute top-0 left-0 z-[2] block h-[7.284471px] w-full sm:hidden xl:block xl:h-[26.691189px] 3xl:h-auto'
      />
      <div className='gusto-booking relative top-auto left-auto z-[1] flex h-auto min-h-0 w-[361px] flex-col items-center justify-start gap-6 [background:rgb(27_40_27_/_70%)] p-4 text-center sm:absolute sm:top-[76.999969px] sm:left-[192px] sm:h-[678.000061px] sm:w-[384px] lg:relative lg:top-auto lg:left-auto lg:h-auto lg:min-h-[500px] lg:w-[min(100%,568px)] lg:min-w-0 lg:p-6 xl:absolute xl:top-[200px] xl:left-[414px] xl:h-[514px] xl:min-h-0 xl:w-[710px] xl:p-4 3xl:relative 3xl:top-auto 3xl:left-auto 3xl:h-[min(26.7708vw,514px)] 3xl:w-[min(36.9792vw,710px)] 3xl:gap-[min(1.25vw,24px)] 3xl:p-[min(0.8333vw,16px)]'>
      ...
      <Image
        ...
        height={72}
        sizes='100vw'
        className='gusto-reservation-brush-bottom pointer-events-none absolute bottom-0 left-0 z-[2] block h-[7.284471px] w-full sm:h-[14.235302px] xl:h-[26.691189px] 3xl:bottom-[-2px] 3xl:h-auto'
      />
    </section>
  );
}
