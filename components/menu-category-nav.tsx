...
export function MenuCategoryNav({
  ...
  return (
    <motion.nav
      className='gusto-menu__category-nav flex w-full flex-wrap content-center items-center gap-x-2 gap-y-0 sm:content-normal sm:gap-x-4 lg:flex lg:items-end lg:justify-start lg:gap-6 3xl:gap-8'
